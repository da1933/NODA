...
areg_cln = areg[['ADA_CODE', 'AREG_SEQ_NBR', 'ARREST_CREDIT_CODE', \
		 'ARREST_DATE', 'BOFI_NBR', 'SYS_NBR', 'CHARGE_CAT', \
		 'CHARGE_CLASS', 'CHARGE_TYPE', 'DFDN_SEQ_NBR', \
		 'HABITUAL_OFFENDER_FLAG', 'FINAL_DETENTION_FLAG', \
		 'INITIAL_DETENTION_FLAG', 'LEAD_CHARGE_CODE']]

ada_cln  = ada[['ADA_CODE', 'BAR_ADMISSION', 'DOB', \
		'RACE', 'SEX', 'PARTY', 'ALT_PARTY']]

dfdn_cln = dfdn[['BOFI_NBR', 'NAME', 'JUVENILE_FLAG', 'CRIMINAL_FLAG', \
